...
# address = 'http://10.42.0.235:7860'
address = 'http://127.0.0.1:7860'
input_file = "img/2024-02-15-110940.jpg" # Input file path
time = datetime.now()
today = date.today()
...
args=[
    ...
    '/home/kaos/Documents/kaotec/FreeYouNext/tools/faceswap/roop/models/inswapper_128.onnx',##'C:\\Users\educa\stable-diffusion-webui\models\insightface\inswapper_128.onnx', #4 model path
    ...
    True, #11 Swap in source image
    False, #12 Swap in generated image
...
prompt = "(8k, best quality, masterpiece, highly detailed:1.1),realistic portrait photo of fantastic happy man,modern clothing,cinematic lightning,film grain,dynamic pose,bokeh,dof"
